...
export default function VerificarCorreo({ correo, status }) {
    ...
    function submit(e) {
        e.preventDefault();
        post(route("verificar.correo.store"));
    }

    function reenviar() {
        setReenviando(true);
        router.post(route("verificar.correo.reenviar"), {}, {
                        ...
                        <div className="pt-2">
                            <a href={route("logout")}
                                className="font-sans text-[10px] uppercase tracking-widest
                                           text-spa-on-light-dim/50 dark:text-spa-on-dark-dim/40 hover:text-gold/60 transition-colors"
